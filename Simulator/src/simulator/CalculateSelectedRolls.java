 ...
 * @author rzfzr
 */
public class CalculateSelectedRolls extends javax.swing.JFrame {

    /**
     * Creates new form CalculateSelectedRolls
     */
    public CalculateSelectedRolls() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculateSelectedRolls.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CalculateSelectedRolls().setVisible(true);
            }
        });
    }
